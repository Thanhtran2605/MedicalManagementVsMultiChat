...
public class Server extends UnicastRemoteObject implements IPatient, IChat, Serializable {
    ...
    @Override
    public synchronized String insertPatient(int numberCode, String namePatient, String homeTown, String diagnostic, Date dateCome, Date dateOut) throws RemoteException {
        try {
            Statement statement = conn.createStatement();
    ...
    @Override
    public synchronized String updatePatient(int numberCode, String namePatient, String homeTown, String diagnostic, Date dateCome, Date dateOut) throws RemoteException {
        try {
            Statement statement = conn.createStatement();
    ...
    public synchronized List<Patient> searchPatient(String name) throws RemoteException {
        ...
        try {
            ...
            Statement statement = conn.createStatement();
            String sql = "select * from patient where namePatient like N'%" + name + "%'";
